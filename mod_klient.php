...
<body>
    <div class="content-container">
        ...
        <div class="header"><p>Zmodyfikuj dane klienta</p></div>
    ...
    <?php
        if($_GET["id"]!=null){
            if(isset($_POST["submit"])){
                ...
                if($_POST["chk-imie"]){$sql=$sql." imie='$imie'"; if($_POST['chk-nazwisko']||$_POST['chk-miejscowosc']||$_POST['chk-kod_pocztowy']||$_POST['chk-ulica']||$_POST['chk-nr_domu']||$_POST['chk-nr_telefonu']){$sql=$sql.",";}}
                if($_POST["chk-nazwisko"]){$sql=$sql." nazwisko='$nazwisko'"; if($_POST['chk-miejscowosc']||$_POST['chk-kod_pocztowy']||$_POST['chk-ulica']||$_POST['chk-nr_domu']||$_POST['chk-nr_telefonu']){$sql=$sql.",";}}
                if($_POST["chk-miejscowosc"]){$sql=$sql." miejscowosc='$miejscowosc'"; if($_POST['chk-kod_pocztowy']||$_POST['chk-ulica']||$_POST['chk-nr_domu']||$_POST['chk-nr_telefonu']){$sql=$sql.",";}}
                if($_POST["chk-kod_pocztowy"]){$sql=$sql." kod_pocztowy='$kod_pocztowy'"; if($_POST['chk-ulica']||$_POST['chk-nr_domu']||$_POST['chk-nr_telefonu']){$sql=$sql.",";}}
                if($_POST["chk-ulica"]){$sql=$sql." ulica='$ulica'"; if($_POST['chk-nr_domu']||$_POST['chk-nr_telefonu']){$sql=$sql.",";}}
                if($_POST["chk-nr_domu"]){$sql=$sql." nr_domu='$nr_domu'"; if($_POST['chk-nr_telefonu']){$sql=$sql.",";}}
                if($_POST["chk-nr_telefonu"]){$sql=$sql." nr_telefonu='$nr_telefonu'";}

                $sql=$sql." WHERE ID_klienta='$id'";
